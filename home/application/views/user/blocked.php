...
<link rel="stylesheet" type="text/css" href="<?= base_url('assets/blocked_page/style.css') ?>">
...
<script type="text/javascript" src="<?= base_url('assets/blocked_page/main.js') ?>"></script>
